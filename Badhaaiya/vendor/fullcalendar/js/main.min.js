...
var FullCalendar = (function (e) {
  ...
  function b (e) {
    ;((!e.__d && (e.__d = !0) && a.push(e) && !C.__r++) ||
      ...
      ((l = i.debounceRendering) || s)(C)
  }
  function C () {
    for (var e; (C.__r = a.length); )
  ...
  function w (e, t, n, r, o, i, a, s, l, u) {
    var c,
      ...
      w = C.length
    for (
      l == d && (l = null != a ? a[0] : w ? S(r, 0) : null), n.__k = [], c = 0;
      c < t.length;
      c++
    )
      if (
        null !=
        (g = n.__k[c] =
          null == (g = t[c]) || 'boolean' == typeof g
            ? null
            : 'string' == typeof g || 'number' == typeof g
            ? m(null, g, null, null, g)
            : Array.isArray(g)
            ? m(y, { children: g }, null, null, null)
        ...
        if (
          ((g.__ = n),
          (g.__b = n.__b + 1),
          null === (h = C[c]) || (h && g.key == h.key && g.type === h.type))
        )
          C[c] = void 0
        else
          for (f = 0; f < w; f++) {
        ...
        ;(E = I(e, g, (h = h || d), o, i, a, s, l, u)),
          (f = g.ref) &&
            h.ref != f &&
            (b || (b = []),
            h.ref && b.push(h.ref, null, g),
            b.push(f, g.__c || E, g)),
          null != E
            ? (null == D && (D = E),
              (l = R(e, g, h, C, a, E, l)),
              u || 'option' != n.type
                ...
                : (e.value = ''))
            : l && h.__e == l && l.parentNode != e && (l = S(h))
      }
    if (((n.__e = D), null != a && 'function' != typeof n.type))
      for (c = a.length; c--; ) null != a[c] && v(a[c])
    ...
    if ((o && 'className' == t && (t = 'class'), 'style' === t))
      ...
      'o' === t[0] && 'n' === t[1]
        ? ((i = t !== (t = t.replace(/Capture$/, ''))),
          ...
          (e.l[t + i] = n),
          (s = i ? x : M),
          n ? r || e.addEventListener(t, s, i) : e.removeEventListener(t, s, i))
        : 'list' !== t &&
          'tagName' !== t &&
          'form' !== t &&
          'type' !== t &&
  ...
  function _ (e, t, n) {
    ...
    for (r = 0; r < e.__k.length; r++)
      (o = e.__k[r]) &&
        ((o.__ = e),
        o.__e &&
          ('function' == typeof o.type && o.__k.length > 1 && _(o, t, n),
      ...
      e: if ('function' == typeof R) {
        if (
          ...
          null != R.getDerivedStateFromProps &&
            ...
            h(d.__s, R.getDerivedStateFromProps(S, d.__s))),
          (f = d.props),
          (v = d.state),
          p)
        )
          ...
          if (
            (null == R.getDerivedStateFromProps &&
              ...
              d.componentWillReceiveProps(S, b),
            (!d.__e &&
              null != d.shouldComponentUpdate &&
              !1 === d.shouldComponentUpdate(S, d.__s, b)) ||
              t.__v === n.__v)
          ) {
            ;(d.props = S),
              (d.state = d.__s),
        ...
        ;(d.context = b),
          ...
          p ||
            ...
            (g = d.getSnapshotBeforeUpdate(f, v)),
          (C =
            null != c && c.type == y && null == c.key ? c.props.children : c),
          w(e, Array.isArray(C) ? C : [C], t, n, r, o, a, s, l, u),
          (d.base = t.__e),
          (t.__h = null),
          d.__h.length && s.push(d),
          m && (d.__E = d.__ = null),
  ...
  function N (e, t, n, r, o, i, a, s) {
    ...
    if (null === t.type) v === g || (s && e.data === g) || (e.data = g)
    else {
      if (
        (null != i && (i = p.slice.call(e.childNodes)),
        (c = (v = n.props || d).dangerouslySetInnerHTML),
        ...
        ;(f || c) &&
          ((f && ((c && f.__html == c.__html) || f.__html === e.innerHTML)) ||
      ...
      ;(function (e, t, n, r, o) {
        ...
        s ||
          ('value' in g &&
            ...
            k(e, 'value', l, v.value, !1),
          'checked' in g &&
            void 0 !== (l = g.checked) &&
            l !== e.checked &&
            k(e, 'checked', l, v.checked, !1))
    }
    return e
  }
  function H (e, t, n) {
  ...
  function Ge (e, t, n) {
    ...
    a)) {
      ...
      if (u.recurringDef) {
        ...
        for (
          var d = 0, p = qe(u, c, t, r, o.recurringTypes);
          d < p.length;
          d++
        ) {
          var f = p[d],
            h = Ne(l, { start: f, end: r.add(f, c) })
          s[h.instanceId] = h
        }
      }
    }
  ...
  function ot (e) {
    return (
      de(e.getUTCHours(), 2) +
      ':' +
      de(e.getUTCMinutes(), 2) +
      ':' +
      de(e.getUTCSeconds(), 2)
    )
  }
  function it (e, t) {
    void 0 === t && (t = !1)
  ...
  var ut = {
    ...
    gt = (function () {
      function e (e) {
        ...
        for (var o in e)
          o in ut
            ? ((n[o] = e[o]), (r = Math.max(ut[o], r)))
            : ((t[o] = e[o]), o in ct && (r = Math.max(ct[o], r)))
        ;(this.standardDateProps = t),
          (this.extendedSettings = n),
          (this.severity = r),
          (this.buildFormattingFunc = st(mt))
      }
      return (
  ...
  function Nt (e, t, n, r) {
    for (
      var o = { defs: {}, instances: {} }, i = Kt(n), a = 0, s = e;
      a < s.length;
      a++
    ) {
  ...
  var Gt = { id: String, groupId: String, title: String, url: String },
    qt = { start: Pt, end: Pt, date: Pt, allDay: Boolean },
    Yt = r(r(r({}, Gt), qt), { extendedProps: Pt })
  ...
  function $t (e) {
    var t = Math.floor(Se(e.start, e.end)) || 1,
      n = we(e.start)
  ...
  function Qt (e, t) {
    ...
    return (
      e.start && ((n = we(e.start)), r && r <= n && (r = me(n, 1))),
      { start: n, end: r }
    )
  }
  function en (e) {
  ...
  function tn (e, t, n, r) {
    return 'year' === r
      ? Xe(n.diffWholeYears(e, t), 'year')
      : 'month' === r
      ? Xe(n.diffWholeMonths(e, t), 'month')
      : De(e, t)
  }
  function nn (e, t) {
    var n,
      ...
      o = [],
      i = t.start
    for (e.sort(rn), n = 0; n < e.length; n += 1)
  ...
  function cn (e, t, n, r) {
    ...
    for (var c in i)
      for (var b = 0, C = nn(i[c], n); b < C.length; b++) {
        D = C[b]
        s.push({
          def: e.defs[c],
          ui: u[c],
  ...
  function Dn (e, t, n, r, o, i, a) {
    ...
    if (
      ...
      var f =
          i ||
          (e.isStart ? p.range.start : e.start || e.eventRange.range.start),
  ...
  function _n (e, t, n) {
    var r = Xt({ editable: !1 }, n),
      o = Jt(r.refined, r.extra, '', e.allDay, !0, n)
    return {
      def: o,
      ui: vn(o, t),
      instance: Ne(o.defId, e.range),
      range: e.range,
      isStart: !0,
      isEnd: !0
    }
  ...
  function Pn (e, t) {
    ...
    return (
      r(
        ...
        ((n = e),
        (o = t.dateEnv),
        r(r({}, xn(n.range, o, n.allDay)), { allDay: n.allDay }))
      ),
      i
    )
  }
  function Nn (e, t, n) {
    ...
    return (
      e
        ? ((i = we(i)), (i = r.add(i, o.defaultAllDayEventDuration)))
  ...
  function Hn (e, t, n, r) {
    ...
    for (var a in e.defs) {
      var s = e.defs[a]
      i.defs[a] = On(s, o[a], n, r)
    }
    for (var l in e.instances) {
      var u = e.instances[l]
      s = i.defs[u.defId]
      i.instances[l] = An(u, s, o[u.defId], n, r)
    }
    return i
  }
  function On (e, t, n, o) {
  ...
  function An (e, t, n, o, i) {
    ...
    return (
      ...
      l &&
        (u.range = {
          start: u.range.start,
          end: Nn(t.allDay, u.range.start, i)
        }),
      t.allDay &&
        (u.range = { start: we(u.range.start), end: we(u.range.end) }),
      u.range.end < u.range.start &&
        (u.range.end = Nn(t.allDay, u.range.start, i)),
      u
    )
  }
  var Un = (function () {
  ...
  function Vn (e) {
    return r(r(r({}, Vt), Ln), e.pluginHooks.eventSourceRefiners)
  }
  function Fn (e, t) {
    return (
      ...
      return (
        ...
        (e.prototype.today = function () {
          ...
          this.unselect(),
            this.dispatch({
              type: 'CHANGE_DATE',
              dateMarker: Fn(e.calendarOptions.now, e.dateEnv)
            })
        }),
        ...
        (e.prototype.addEvent = function (e, t) {
          ...
          if (t instanceof V) o = t.internalEventSource
          else if ('boolean' == typeof t) t && (o = We(i.eventSources)[0])
          else if (null != t) {
          ...
          var s = Zt(e, o, i, !1)
          if (s) {
            var l = new Bn(i, s.def, s.def.recurringDef ? null : s.instance)
            return (
        ...
        (e.prototype.triggerEventAdd = function (e) {
          ...
          this.getCurrentData().emitter.trigger('eventAdd', {
            ...
            relatedEvents: [],
            revert: function () {
              t.dispatch({ type: 'REMOVE_EVENTS', eventStore: jn(e) })
            }
          })
        }),
        ...
        (e.prototype.getEventSourceById = function (e) {
          ...
          for (var r in ((e = String(e)), n))
            if (n[r].publicId === e) return new V(t, n[r])
          return null
        }),
  ...
  function Gn (e, t, n) {
    ...
    for (var s in o) {
      var l = o[s],
        u = r[l.defId]
      l.instanceId !== a && i.push(new Bn(t, u, l))
    }
    return i
  }
  var qn = {}
  ...
  var Jn = (function () {
      ...
      return (
        ...
        (e.prototype.diffWholeMonths = function (e, t) {
          var n = this.calendarSystem
          return Pe(e) === Pe(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
            ? n.getMarkerMonth(t) -
                n.getMarkerMonth(e) +
        ...
        (e.prototype.countDurationsBetween = function (e, t, n) {
          ...
          return n.years && null !== (r = this.diffWholeYears(e, t))
            ...
            : n.days && null !== (r = Ce(e, t))
            ? r / Qe(n)
            : (t.valueOf() - e.valueOf()) / et(n)
        }),
        ...
        (e.prototype.timestampToMarker = function (e) {
          return 'local' === this.timeZone
            ...
            ? _e(this.namedTimeZoneImpl.timestampToArray(e))
            : new Date(e)
        }),
        (e.prototype.offsetForMarker = function (e) {
          return 'local' === this.timeZone
            ? -Me(xe(e)).getTimezoneOffset()
            : 'UTC' === this.timeZone
            ? 0
            : this.namedTimeZoneImpl
            ? this.namedTimeZoneImpl.offsetForArray(xe(e))
            : null
        }),
        (e.prototype.toDate = function (e, t) {
          return 'local' === this.timeZone
            ...
            ? new Date(
                e.valueOf() -
                  1e3 * this.namedTimeZoneImpl.offsetForArray(xe(e)) * 60
              )
  ...
  function rr (e) {
    var t = tr(e.locale || 'en', er([]).map)
    return new Jn(
      r(r({ timeZone: wt.timeZone, calendarSystem: 'gregory' }, e), {
        locale: t
      })
    )
  }
  ...
  var fr = { defs: {}, instances: {} },
    hr = (function () {
      function e () {
        ;(this.getKeysForEventDefs = st(this._getKeysForEventDefs)),
          (this.splitDateSelection = st(this._splitDateSpan)),
          (this.splitEventStore = st(this._splitEventStore)),
          (this.splitIndividualUi = st(this._splitIndividualUi)),
          (this.splitEventDrag = st(this._splitInteraction)),
          (this.splitEventResize = st(this._splitInteraction)),
      ...
      return (
        (e.prototype.splitProps = function (e) {
          ...
          for (var c in ((this.eventUiBuilders = Ue(n, function (e, n) {
            return t.eventUiBuilders[n] || st(vr)
          })),
          n)) {
            var d = n[c],
              p = a[c] || fr,
          ...
          if (e) {
            var n = this._splitEventStore(
              ...
              i = function (r) {
                t[r] ||
                  (t[r] = {
                    affectedEvents: n[r] || fr,
                    mutatedEvents: o[r] || fr,
                    isEvent: e.isEvent
                  })
              }
            for (var a in n) i(a)
  ...
  function Rr (e, t, n) {
    void 0 === t && (t = !1)
    var r = n ? e.getBoundingClientRect() : Tr(e),
      o = wr(e, t),
      i = {
  ...
  var Or = FullCalendarVDom.Component,
    Ar = FullCalendarVDom.createElement,
    Ur = FullCalendarVDom.render,
    Lr = FullCalendarVDom.createRef,
    Wr = FullCalendarVDom.Fragment,
    Vr = FullCalendarVDom.createContext,
    Fr = FullCalendarVDom.flushToDom,
    zr = FullCalendarVDom.unmountComponentAtNode,
    Br = (function () {
      function e (e, t, n) {
        var o = this
        ;(this.execFunc = e),
    ...
    jr = Vr({})
  function Gr (e, t, n, r, o, i, a, s, l, u, c, d, p) {
    return {
      dateEnv: o,
      options: n,
      pluginHooks: a,
      ...
      createScrollResponder: function (e) {
        return new Br(e, u, Xe(n.scrollTime))
      },
  ...
  var qr = (function (e) {
    ...
    return (
      ...
      (t.prototype.shouldComponentUpdate = function (e, t) {
        return (
          this.debug && console.log(Fe(e, this.props), Fe(t, this.state)),
          !ze(this.props, e, this.propEquality) ||
            !ze(this.state, t, this.stateEquality)
        )
      }),
      (t.addPropsEquality = Zr),
      (t.addStateEquality = Xr),
      (t.contextType = jr),
      t
    )
  })(Or)
  ;(qr.prototype.propEquality = {}), (qr.prototype.stateEquality = {})
  var Yr = (function (e) {
    function t () {
      return (null !== e && e.apply(this, arguments)) || this
    }
    return n(t, e), (t.contextType = jr), t
  })(qr)
  function Zr (e) {
      ...
      case 'RECEIVE_EVENTS':
        return (function (e, t, n, r, o, i) {
          if (t && n === t.latestFetchId) {
            ...
            return r && (a = Ge(a, r, i)), Ut(Qr(e, t.sourceId), a)
          }
          return e
  ...
  function to (e, t) {
    ...
    return (t.pluginHooks.isPropsValid || no)(o, t)
  }
  function no (e, t, n, o) {
    return (
      void 0 === n && (n = {}),
      !(
        ...
        !(function (e, t, n, o) {
          ...
          for (var m in u) {
            var y = u[m],
              ...
              S = c[y.defId],
              D = l[y.defId]
            if (!ro(S.constraints, E, d, e.businessHours, t)) return !1
            ...
            for (var w in f) {
              ...
              if (sn(E, R.range)) {
                ...
                if (C && !C(new Bn(t, p[R.defId], R), new Bn(t, D, y)))
                  return !1
              }
            }
            for (var T = i.eventStore, k = 0, M = S.allows; k < M.length; k++) {
              var x = M[k],
                _ = r(r({}, n), { range: y.range, allDay: D.allDay }),
                I = T.defs[D.defId],
                P = T.instances[m],
                N = void 0
              if (((N = I ? new Bn(t, I, P) : new Bn(t, D)), !x(Pn(_, t), N)))
                return !1
            }
          }
          return !0
        ...
        !(
          ...
          !(function (e, t, n, o) {
            ...
            o && (c = o(c))
            if (!ro(c.constraints, u, i, e.businessHours, t)) return !1
            ...
            for (var f in s) {
              ...
              if (sn(u, h.range)) {
                ...
                if (p && !p(new Bn(t, a[h.defId], h), null)) return !1
              }
            }
            for (var v = 0, g = c.allows; v < g.length; v++) {
              var m = g[v],
                y = r(r({}, n), l)
              if (!m(Pn(y, t), null)) return !1
            }
            return !0
          })(e, t, n, o)
        )
  ...
  function ro (e, t, n, r, o) {
    for (var i = 0, a = e; i < a.length; i++) {
      if (!ao(oo(a[i], t, n, r, o), t)) return !1
    }
    return !0
  }
  ...
  var so = (function (e) {
    ...
    return (
      ...
      (t.prototype.isDateSelectionValid = function (e) {
        ...
        return (
          !(r && !ln(r.validRange, e.range)) &&
          ((t = e), (n = this.context), to({ dateSelection: t }, n))
        )
      }),
      ...
      (t.prototype.isValidDateDownEl = function (e) {
        return !(
          z(e, '.fc-event:not(.fc-bg-event)') ||
          z(e, '.fc-daygrid-more-link') ||
          z(e, 'a[data-navlink]') ||
          z(e, '.fc-popover')
        )
      }),
  ...
  var fo = (function (e) {
      function t () {
        ...
        return (
          ...
          (t.handleRootEl = function (e) {
            Kr(t.rootElRef, e), t.props.elRef && Kr(t.props.elRef, e)
          }),
          t
        )
      }
          ...
          return Ar(
            ...
            function (r) {
              return Ar(
                ...
                function (e, o) {
                  return t.children(r, Eo(t.classNames, n), e, o)
                }
              )
            }
          )
    ...
    ho = Vr(0)
  function vo (e) {
    return Ar(ho.Consumer, null, function (t) {
      return Ar(go, r({ renderId: t }, e))
    })
  }
  var go = (function (e) {
      function t () {
        var t = (null !== e && e.apply(this, arguments)) || this
        return (t.innerElRef = Lr()), t
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
        ...
        (t.prototype.renderInnerContent = function () {
          var e = this.context.pluginHooks.contentTypeHandlers,
            ...
            o = So(t.content, t.hookProps),
            i = null
          if (
            (void 0 === o && (o = So(t.defaultContent, t.hookProps)),
            void 0 !== o)
          ) {
    ...
    mo = (function (e) {
      function t () {
        ...
        return (
          (t.handleRootEl = function (e) {
            ;(t.rootEl = e), t.props.elRef && Kr(t.props.elRef, e)
          }),
          t
        )
      }
  ...
  function yo () {
    var e,
      ...
      n = []
    return function (r, o) {
      return (t && Ve(t, o) && r === e) || ((e = r), (t = o), (n = Eo(r, o))), n
    }
  }
  function Eo (e, t) {
  ...
  function So (e, t) {
    return 'function' == typeof e ? e(t, Ar) : e
  }
  var Do = (function (e) {
    function t () {
      var t = (null !== e && e.apply(this, arguments)) || this
      return (t.normalizeClassNames = yo()), t
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
  ...
  function Co (e) {
    ...
    return (
      n.content &&
        ((t = n),
        (o = function (e) {
          return Ar(jr.Consumer, null, function (n) {
            return Ar(Do, { viewSpec: n.viewSpec }, function (o, i) {
              var a = r(r({}, e), {
  ...
  var To = (function () {
    function e (e) {
      ;(this.props = e),
        (this.nowDate = Fn(e.nowInput, e.dateEnv)),
        this.initHiddenDays()
    }
    return (
      ...
      (e.prototype.build = function (e, t, n) {
        ...
        return (
          ...
          d.showNonCurrentDates || (s = on(s, o.range)),
          (s = on((s = this.adjustActiveRange(s)), r)),
          (l = sn(o.range, r)),
          {
            validRange: r,
      ...
      (e.prototype.buildCurrentRangeInfo = function (e, t) {
        ...
        return (
          r.duration
            ...
            : ((i = nt((o = this.getFallbackDuration())).unit),
              (a = this.buildRangeFromDuration(e, t, o, i))),
      ...
      (e.prototype.adjustActiveRange = function (e) {
        ...
        return (
          r &&
            (Qe(o) < 0 && ((a = we(a)), (a = n.add(a, o))),
            Qe(i) > 1 && ((s = me((s = we(s)), -1)), (s = n.add(s, i)))),
          { start: a, end: s }
        )
      }),
      (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
        ...
        return (
          Qe(n) <= 1 &&
            this.isHiddenDay(o) &&
            (o = we((o = this.skipHiddenDays(o, t)))),
          d(),
      ...
      (e.prototype.buildDateIncrement = function (e) {
        ...
        return (
          n ||
          ((t = this.props.dateAlignment) ? Xe(1, t) : e || Xe({ days: 1 }))
        )
      }),
  ...
  function Mo (e, t, n, o) {
    ...
    switch (t.type) {
      ...
      case 'FETCH_EVENT_SOURCES':
        return Po(e, t.sourceIds ? Le(t.sourceIds) : Ho(e, o), s, o)
      case 'RECEIVE_EVENTS':
  ...
  function Vo (e, t, n, r, o) {
    ...
    return {
      headerToolbar: e.headerToolbar
        ? Fo(e.headerToolbar, e, t, n, r, o, i)
        : null,
      footerToolbar: e.footerToolbar
        ? Fo(e.footerToolbar, e, t, n, r, o, i)
        : null,
      viewsWithButtons: i
    }
  }
  ...
  function jo (e, t) {
    for (
      var n = We(t.getCurrentData().eventSources), r = [], o = 0, i = e;
      o < i.length;
      o++
    ) {
      ...
      eventSourceDefs: [
        {
          ...
          fetch: function (e, t, n) {
            ...
            Mr(
              e.eventSource.meta.bind(null, Mn(e.range, r)),
              function (e) {
                t({ rawEvents: e })
              },
              n
    ...
    lo({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            'datesSet',
            r(r({}, Mn(e.activeRange, t.dateEnv)), { view: t.viewApi })
          )
        },
        eventStore: function (e, t) {
          var n = t.emitter
          n.hasHandlers('eventsSet') && n.trigger('eventsSet', Gn(e, t))
        }
      }
    })
  ]
    ...
    Xo = (function () {
      function e (e, t) {
        ;(this.runTaskOption = e),
          ...
          (this.queue = []),
          (this.delayedRunner = new Zo(this.drain.bind(this)))
      }
      return (
  ...
  var Jo = (function () {
    function e (e) {
      var t = this
      ;(this.computeOptionsData = st(this._computeOptionsData)),
        (this.computeCurrentViewData = st(this._computeCurrentViewData)),
        (this.organizeRawLocales = st(er)),
        (this.buildLocale = st(tr)),
        (this.buildPluginHooks = uo()),
        (this.buildDateEnv = st($o)),
        (this.buildTheme = st(Qo)),
        (this.parseToolbars = st(Vo)),
        (this.buildViewSpecs = st(wo)),
        (this.buildDateProfileGenerator = lt(ei)),
        (this.buildViewApi = st(ti)),
        (this.buildViewUiProps = lt(oi)),
        (this.buildEventUiBySource = st(ni, Ve)),
        (this.buildEventUiBases = st(ri)),
        (this.parseContextBusinessHours = lt(ai)),
        (this.buildTitle = st(Ko)),
        (this.emitter = new xr()),
        (this.actionRunner = new Xo(
      ...
      var s,
        ...
        c =
          ((s = o.calendarOptions),
          (l = o.dateEnv),
          null != (u = s.initialDate) ? l.createMarker(u) : Fn(s.now, l)),
        d = a.dateProfileGenerator.build(c)
      un(d.activeRange, c) || (c = d.currentRange.start)
      for (
        var p = {
            dateEnv: o.dateEnv,
      ...
      for (
        var v = ko(o.calendarOptions, d, p),
          g = {
      ...
      ii(g, p) && this.emitter.trigger('loading', !0),
        (this.state = g),
        this.updateData(),
    ...
    return (
        ...
        this.data &&
          ...
          (d = (function (e, t, n, r) {
            ...
            switch (t.type) {
              ...
              case 'CHANGE_DATE':
                if (!e.activeRange || !un(e.currentRange, t.dateMarker))
          ...
          un(d.currentRange, c) || (c = d.currentRange.start)
        for (
          var p = Mo(n.eventSources, e, d, u),
            f = Jr(n.eventStore, e, p, d, u),
            h =
              (xo(p) &&
            ...
            E = {
              ...
              dateSelection: Ao(n.dateSelection, e),
              eventSelection: Uo(n.eventSelection, e),
              eventDrag: Lo(n.eventDrag, e),
              eventResize: Wo(n.eventResize, e)
            },
            S = r(r({}, u), E),
            D = 0,
            b = a.pluginHooks.reducers;
          D < b.length;
          D++
        ) {
          var C = b[D]
      ...
      (e.prototype.processRawCalendarOptions = function (e, t) {
        var n = _t([wt, e, t]),
          ...
          u = this.buildPluginHooks(e.plugins || [], Go),
          c = (this.currentCalendarOptionsRefiners = r(
            r(r(r(r({}, Ct), Rt), Tt), u.listenerRefiners),
            u.optionRefiners
          )),
          d = {},
          p = _t([wt, l, e, t]),
        ...
        for (var m in p)
          'plugins' !== m &&
            (p[m] === h[m] || (kt[m] && m in h && kt[m](h[m], p[m]))
              ? (f[m] = v[m])
              : c[m]
              ? ((f[m] = c[m](p[m])), (g = !0))
              : (d[m] = h[m]))
      ...
      (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
        var a = _t([wt, e.optionDefaults, n, o, e.optionOverrides, i]),
          s = r(
            r(r(r(r(r({}, Ct), Rt), Tt), xt), t.listenerRefiners),
            t.optionRefiners
          ),
          l = {},
  ...
  function $o (e, t, n, r, o, i, a, s) {
    var l = tr(t || a.defaultCode, a.map)
    return new Jn({
  ...
  function Qo (e, t) {
    return new (t.themeClasses[e.themeSystem] || co)(e)
  }
  function ei (e) {
    return new (e.dateProfileGeneratorClass || To)(e)
  }
  function ti (e, t, n) {
    return new Un(e, t, n)
  }
  ...
  var fi = {},
    ...
    vi = {},
    gi = { startTime: Xe, duration: Xe, create: Boolean, sourceId: String }
  function mi (e) {
    var t = It(e, gi),
      n = t.refined,
      r = t.extra
  ...
  var yi = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            ...
            if ('title' === c)
              (a = !1),
                i.push(Ar('h2', { className: 'fc-toolbar-title' }, t.title))
            else {
          ...
          if (i.length > 1) {
            ...
            return Ar.apply(void 0, o(['div', { className: m }], i))
          }
          return i[0]
        }),
        t
      ...
      function t () {
        ...
        return (
          ...
          (t.handleEl = function (e) {
            ;(t.el = e), Kr(t.props.elRef, e), t.updateAvailableWidth()
          }),
        ...
        return (
          (n.handleSegClick = function (e, t) {
            ...
            if (i && r.isValidSegDownEl(e.target)) {
              var a = z(e.target, '.fc-event-forced-url'),
          ...
          (n.destroy = K(t.el, 'click', '.fc-event', n.handleSegClick)),
          n
        )
      }
      return n(t, e), t
      ...
      function t (t) {
        ...
        return (
          ...
          (s.handleSegLeave = function (e, t) {
            s.currentSegEl &&
              ((s.currentSegEl = null), s.triggerEvent('eventMouseLeave', e, t))
          }),
      ...
      return (
        ...
        (t.prototype.triggerEvent = function (e, t, n) {
          ...
          ;(t && !r.isValidSegDownEl(t.target)) ||
            o.emitter.trigger(e, {
              el: n,
              event: new Bn(o, i.eventRange.def, i.eventRange.instance),
              jsEvent: t,
              view: o.viewApi
            })
        }),
    ...
    Ci = (function (e) {
      function t () {
        var t = (null !== e && e.apply(this, arguments)) || this
        return (
          (t.buildViewContext = st(Gr)),
          (t.buildViewPropTransformers = st(Ri)),
          (t.buildToolbarProps = st(wi)),
          (t.handleNavLinkClick = X(
            'a[data-navlink]',
          ...
          (t.registerInteractiveComponent = function (e, n) {
            ...
            ;(t.interactionsStore[e.uid] = o), (fi[e.uid] = r)
          }),
          (t.unregisterInteractiveComponent = function (e) {
            for (var n = 0, r = t.interactionsStore[e.uid]; n < r.length; n++) {
              r[n].destroy()
            }
            delete t.interactionsStore[e.uid], delete fi[e.uid]
          }),
          (t.resizeRunner = new Zo(function () {
            t.props.emitter.trigger('_resize', !0),
              t.props.emitter.trigger('windowResize', { view: t.props.viewApi })
          })),
  ...
  var Ti = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return pr() || i.push('fc-liquid-hack'), e.children(i, o, r, n)
      }),
      (t.prototype.componentDidMount = function () {
  ...
  var _i = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            u = [Mi].concat(mr(l, o), e.extraClassNames || []),
    ...
    Pi = (function (e) {
      function t (t, n) {
        ...
        return (
          (r.initialNowDate = Fn(n.options.now, n.dateEnv)),
      ...
      return (
        ...
        (t.prototype.computeTiming = function () {
          var e = this.props,
            ...
            o = t.dateEnv.add(r, Xe(1, e.unit)),
            i = o.valueOf() - n.valueOf()
          return (
            (i = Math.min(864e5, i)),
            {
              currentState: { nowDate: r, todayRange: Ni(r) },
              nextState: { nowDate: o, todayRange: Ni(o) },
              waitMs: i
            }
          )
        }),
  ...
  var Hi = (function (e) {
    function t () {
      var t = (null !== e && e.apply(this, arguments)) || this
      return (t.createDayHeaderFormatter = st(Oi)), t
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
        ...
        return Ar(Pi, { unit: 'day' }, function (e, t) {
          return Ar(
            'tr',
            null,
            i && i('day'),
  ...
  var Ai = (function () {
      ...
      return (
        (e.prototype.sliceRange = function (e) {
          var t = this.getDateDayIndex(e.start),
            n = this.getDateDayIndex(me(e.end, -1)),
            r = Math.max(0, t),
        ...
        (e.prototype.getDateDayIndex = function (e) {
          var t = this.indices,
            n = Math.floor(Se(this.dates[0], e))
    ...
    Li = (function () {
      function e () {
        ;(this.sliceBusinessHours = st(this._sliceBusinessHours)),
          (this.sliceDateSelection = st(this._sliceDateSpan)),
          (this.sliceEventStore = st(this._sliceEventStore)),
      ...
      return (
        ...
        (e.prototype.sliceNowDate = function (e, t) {
          ...
          return this._sliceDateSpan.apply(
            this,
            o([{ range: { start: e, end: ye(e, 1) }, allDay: !1 }, {}, t], n)
          )
        }),
        ...
        (e.prototype._sliceInteraction = function (e, t, n, r) {
          for (var o = [], i = 4; i < arguments.length; i++)
            o[i - 4] = arguments[i]
          if (!e) return null
          var a = cn(e.mutatedEvents, t, Wi(n, Boolean(r)), r)
          return {
        ...
        (e.prototype.sliceEventRange = function (e, t) {
          ...
          this.forceDayIfListItem &&
            ...
            (n = { start: n.start, end: me(n.start, 1) })
          for (
  ...
  var Vi = /^(visible|hidden)$/,
    Fi = (function (e) {
      function t () {
        var t = (null !== e && e.apply(this, arguments)) || this
        return (
          (t.handleEl = function (e) {
            ;(t.el = e), Kr(t.props.elRef, e)
          }),
          t
        )
      }
      return (
        ...
        (t.prototype.needsXScrolling = function () {
          if (Vi.test(this.props.overflowX)) return !1
          for (
            var e = this.el,
              t =
        ...
        (t.prototype.needsYScrolling = function () {
          if (Vi.test(this.props.overflowY)) return !1
          for (
            var e = this.el,
              t =
  ...
  function Bi (e) {
    for (
      var t = 0, n = 0, r = j(e, '.fc-scrollgrid-shrink');
      n < r.length;
      n++
    ) {
      var o = r[n]
    ...
    for (var n = [], r = 0, i = e; r < i.length; r++)
      for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1)
        n.push(
          Ar('col', {
            style: {
              width: 'shrink' === a.width ? Xi(t) : a.width || '',
              minWidth: a.minWidth || ''
            }
          })
        )
    return Ar.apply(void 0, o(['colgroup', {}], n))
  }
  function Xi (e) {
    return null == e ? 4 : e
  }
  ...
  var na = (function (e) {
    function t () {
      var t = (null !== e && e.apply(this, arguments)) || this
      return (
        (t.processCols = st(function (e) {
          return e
        }, Yi)),
        (t.renderMicroColGroup = st(Zi)),
        (t.scrollerRefs = new zi()),
        (t.scrollerElRefs = new zi(t._handleScrollerEl.bind(t))),
        (t.state = {
          shrinkWidth: null,
          forceYScrollbars: !1,
    ...
    return (
      ...
      (t.prototype.render = function () {
        for (
          ...
          d.push(this.renderSection(e, s)), (c += 1)
        for (; c < u && 'body' === (e = i[c]).type; )
          p.push(this.renderSection(e, s)), (c += 1)
        for (; c < u && 'footer' === (e = i[c]).type; )
          f.push(this.renderSection(e, s)), (c += 1)
        var h = !pr()
        return Ar(
          'table',
          { className: l.join(' '), style: { height: t.height } },
          Boolean(!h && d.length) && Ar.apply(void 0, o(['thead', {}], d)),
          Boolean(!h && p.length) && Ar.apply(void 0, o(['tbody', {}], p)),
          Boolean(!h && f.length) && Ar.apply(void 0, o(['tfoot', {}], f)),
          h && Ar.apply(void 0, o(['tbody', {}], d, p, f))
        )
      }),
      (t.prototype.renderSection = function (e, t) {
        return 'outerContent' in e
          ? Ar(Wr, { key: e.key }, e.outerContent)
          : Ar(
              'tr',
              { key: e.key, className: $i(e, this.props.liquid).join(' ') },
      ...
      (t.prototype.renderChunkTd = function (e, t, n) {
        ...
        return Ar(
          ...
          Ar(
            ...
            {
              className:
                'fc-scroller-harness' + (u ? ' fc-scroller-harness-liquid' : '')
            },
            Ar(
              Fi,
              {
      ...
      (t.prototype.computeShrinkWidth = function () {
        return Ki(this.props.cols) ? Bi(this.scrollerElRefs.getAll()) : 0
      }),
  ...
  na.addStateEquality({ scrollerClientWidths: Ve, scrollerClientHeights: Ve })
  var ra = (function (e) {
      function t () {
        var t = (null !== e && e.apply(this, arguments)) || this
        return (t.elRef = Lr()), t
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            i = o.ui,
            a = {
              event: new Bn(t, o.def, o.instance),
              view: t.viewApi,
              timeText: e.timeText,
        ...
        (t.prototype.render = function () {
          ...
          return Ar(
            ra,
            {
              ...
              defaultContent: e.defaultContent || ia,
  ...
  function ia (e) {
    return Ar(
      ...
      e.timeText && Ar('div', { className: 'fc-event-time' }, e.timeText),
      Ar(
        'div',
        ...
        Ar(
          ...
          e.event.title || Ar(Wr, null, ' ')
        )
      )
    )
  }
  var aa = function (e) {
      return Ar(jr.Consumer, null, function (t) {
        var n = t.options,
          r = {
            isAxis: e.isAxis,
  ...
  function ua (e) {
    var t = e.date,
      n = e.dateEnv,
      o = gr(t, e.todayRange, null, e.dateProfile)
    return r(
      r(r({ date: n.toDate(t), view: e.viewApi }, o), {
        dayNumberText: e.showDayNumber ? n.format(t, sa) : ''
      }),
      e.extraProps
    )
  }
  var ca = (function (e) {
    function t () {
      var t = (null !== e && e.apply(this, arguments)) || this
      return (t.refineHookProps = lt(ua)), (t.normalizeClassNames = yo()), t
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
  ...
  function fa (e) {
    return (
      e.event.title && Ar('div', { className: 'fc-event-title' }, e.event.title)
    )
  }
  var ha = function (e) {
    return Ar(jr.Consumer, null, function (t) {
  ...
  var ga = (function (e) {
    function t (t, n) {
      ...
      return (
                ...
                function (t, n, i, a) {
                  return (
                    ...
                    Ar(
                      ...
                      Ar(Ci, r({ isHeightAuto: i, forPrint: a }, e))
                    )
                  )
                }
              ),
        ...
        (o.el = t),
        (o.renderRunner = new Zo(o.handleRenderRequest)),
        new Jo({
          optionOverrides: n,
          calendarApi: o,
    ...
    return (
      ...
      (t.prototype.updateSize = function () {
        e.prototype.updateSize.call(this), Fr()
      }),
    ...
    Sa = (function () {
      function e (e) {
        ...
        ;(this.subjectEl = null),
          ...
          1 === (ya += 1) &&
            window.addEventListener('touchmove', Da, { passive: !1 })
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            (ya -= 1) ||
              window.removeEventListener('touchmove', Da, { passive: !1 })
        }),
        (e.prototype.tryStart = function (e) {
          var t = this.querySubjectEl(e),
            n = e.target
          return (
            !(!t || (this.handleSelector && !z(n, this.handleSelector))) &&
            ((this.subjectEl = t),
            (this.isDragging = !0),
            (this.wasTouchScroll = !1),
            !0)
  ...
  var ba = (function () {
      ...
      return (
        ...
        (e.prototype.doRevertAnimation = function (e, t) {
          ...
          ;(n.style.transition = 'top ' + t + 'ms,left ' + t + 'ms'),
            q(n, { left: r.left, top: r.top }),
            $(n, function () {
              ;(n.style.transition = ''), e()
            })
        }),
        (e.prototype.cleanup = function () {
          this.mirrorEl && (F(this.mirrorEl), (this.mirrorEl = null)),
            (this.sourceEl = null)
        }),
    ...
    wa = (function (e) {
      function t (t, n) {
        return e.call(this, new Pr(t), n) || this
      }
      return (
        n(t, e),
    ...
    Ra = (function (e) {
      function t (t) {
        return e.call(this, new Nr(), t) || this
      }
      return (
        n(t, e),
        (t.prototype.getEventTarget = function () {
    ...
    Ta = 'function' == typeof performance ? performance.now : Date.now,
    ka = (function () {
      function e () {
        var e = this
        ;(this.isEnabled = !0),
      ...
      return (
        ...
        (e.prototype.computeBestEdge = function (e, t) {
          for (
            var n = this.edgeThreshold, r = null, o = 0, i = this.scrollCaches;
            o < i.length;
            o++
          ) {
            var a = i[o],
        ...
        (e.prototype.buildCaches = function () {
          return this.queryScrollEls().map(function (e) {
            return e === window ? new Ra(!1) : new wa(e, !1)
          })
        }),
    ...
    xa = (function () {
      function e (e) {
        ;(this.origRect = Tr(e)),
          (this.scrollCaches = kr(e).map(function (e) {
            return new wa(e, !0)
          }))
      }
      return (
        ...
        for (var i in n) {
          ...
          if (s && s.isWithinClipping(e, t)) {
            ...
            if (c >= 0 && c < f && d >= 0 && d < h) {
              ...
              v &&
                ln(g.activeRange, v.dateSpan.range) &&
                (!o || v.layer > o.layer) &&
                ((v.rect.left += l),
                (v.rect.right += l),
                (v.rect.top += u),
  ...
  function Ia (e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && kn(e.dateSpan, t.dateSpan))
    )
  }
  function Pa (e, t) {
    for (
  ...
  var Na = (function (e) {
      function t (t) {
        ...
        ;(n.handlePointerDown = function (e) {
          ...
          (n.dragging = new Ma(t.el)),
          (n.dragging.autoScroller.isEnabled = !1)
        var o = (n.hitDragging = new _a(n.dragging, pi(t)))
        return (
    ...
    function t (n) {
      ...
      ;(o.subjectEl = null),
        ...
        (o.handlePointerDown = function (e) {
          ...
          var u = (o.subjectSeg = fn(e.subjectEl)),
            c = (o.eventRange = u.eventRange).instance.instanceId
          ;(o.relevantEvents = Ot(l.getCurrentData().eventStore, c)),
          ...
          e.isTouch
            ...
            o.isDragging &&
              ...
              t.emitter.trigger('eventDragStart', {
                el: o.subjectEl,
                event: new Bn(t, n.def, n.instance),
                jsEvent: e.origEvent,
                view: t.viewApi
              }))
        }),
            ...
            if (e) {
              ...
              i === a || (p.editable && p.droppable)
                ? (s = (function (e, t, n) {
                  ...
                  ((l = Hn(n, a.getCurrentData().eventUiBases, s, a)),
                  (c.mutatedEvents = l),
        ...
        (n.handleDragStart = function (e) {
          ...
          ;(n.draggingSegEl = o),
            ...
            t.emitter.trigger('eventResizeStart', {
              el: o,
              event: new Bn(t, r.def, r.instance),
              jsEvent: e.origEvent,
              view: t.viewApi
            })
        }),
            ...
            (u = (function (e, t, n, o, i) {
              for (
                var a = e.component.context.dateEnv,
                  ...
                  u = tn(s, l, a, e.component.largeUnit),
                  c = {},
                  d = 0,
                  p = i;
                d < p.length;
              ...
              s,
              e,
              o.subjectEl.classList.contains('fc-event-resizer-start'),
              l.range,
              i.pluginHooks.eventResizeJoinTransforms
            )),
            u &&
              ((c = Hn(a, i.getCurrentData().eventUiBases, u, i)),
              (p.mutatedEvents = c),
              n.component.isInteractionValid(p) ||
                ((d = !0), (u = null), (c = null), (p.mutatedEvents = null))),
            c
  ...
  var Ua = (function () {
      function e (e) {
        ...
        ;(this.context = e),
          ...
          (this.onDocumentPointerDown = function (e) {
            var n = t.context.options.unselectCancel,
              r = e.origEvent.target
            ;(t.matchesCancel = !!z(r, n)),
              (t.matchesEvent = !!z(r, Oa.SELECTOR))
          }),
        ...
        var n = (this.documentPointer = new Sa(document))
    ...
    Va = (function () {
      function e (e, t) {
              ...
              if (
                ...
                o.dispatch({ type: 'MERGE_EVENTS', eventStore: u }),
                  ...
                  o.emitter.trigger('eventReceive', {
                    event: new Bn(o, i.def, i.instance),
                    relatedEvents: [],
                    revert: function () {
        ...
        var o = (this.hitDragging = new _a(e, fi))
        ;(o.requireInitial = !1),
      ...
      return (
        (e.prototype.buildDragMeta = function (e) {
          return 'object' == typeof this.suppliedDragMeta
            ? mi(this.suppliedDragMeta)
            : 'function' == typeof this.suppliedDragMeta
            ? mi(this.suppliedDragMeta(e))
            : mi(
                (t = (function (e, t) {
                  var n = vi.dataAttrPrefix,
                    r = (n ? n + '-' : '') + t
        ...
        (e.prototype.canDropElOnCalendar = function (e, t) {
          ...
          return 'function' == typeof n
            ...
            : 'string' != typeof n || !n || Boolean(B(e, n))
        }),
        e
      )
    })()
  ...
  var Fa = (function () {
        ...
        void 0 === t && (t = {}),
          (this.handlePointerDown = function (e) {
            var t = n.dragging,
              ...
              i = r.longPressDelay
            ;(t.minDistance =
              null != o ? o : e.isTouch ? 0 : wt.eventDragMinDistance),
              (t.delay = e.isTouch ? (null != i ? i : wt.longPressDelay) : 0)
          }),
          (this.handleDragStart = function (e) {
            e.isTouch &&
              n.dragging.delay &&
              e.subjectEl.classList.contains('fc-event') &&
              n.dragging.mirror.getMirrorEl().classList.add('fc-event-selected')
          }),
          (this.settings = t)
        var r = (this.dragging = new Ma(e))
    ...
    ja = lo({
      componentInteractions: [Na, Ha, Oa, Aa],
      calendarInteractions: [Ua],
      ...
      return (
        ...
        (t.prototype.renderSimpleLayout = function (e, t) {
          ...
          return (
            ...
            Ar(Do, { viewSpec: r.viewSpec }, function (e, t) {
              return Ar(
                'div',
        ...
        (t.prototype.renderHScrollLayout = function (e, t, n, r) {
          ...
          var i = this.props,
            a = this.context,
            s = !i.forPrint && ea(a.options),
            l = !i.forPrint && ta(a.options),
            u = []
          return (
            e &&
              u.push({
            ...
            l &&
              u.push({
                ...
                key: 'footer',
                isSticky: !0,
                chunks: [{ key: 'main', content: Qi }]
              }),
            Ar(Do, { viewSpec: a.viewSpec }, function (e, t) {
              return Ar(
                'div',
                { ref: e, className: ['fc-daygrid'].concat(t).join(' ') },
                Ar(o, {
      ...
      (t.prototype.render = function () {
        var e = this.props,
          t = this.context.options.navLinks
            ? { 'data-navlink': yr(e.date), tabIndex: 0 }
            : {}
        return Ar(
          la,
          {
          ...
          function (n, o) {
            return (
              ...
              Ar(
                ...
                Ar(
                  'a',
                  r({ className: 'fc-daygrid-day-number' }, t),
                  o || Ar(Wr, null, ' ')
                )
              )
            )
  ...
  var Ja = bt({ week: 'narrow' }),
    $a = (function (e) {
      function t () {
        var t = (null !== e && e.apply(this, arguments)) || this
        return (
          (t.handleRootEl = function (e) {
            ;(t.rootEl = e), Kr(t.props.elRef, e)
          }),
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            u = n.navLinks ? { 'data-navlink': yr(a, 'week'), tabIndex: 0 } : {}
          return Ar(
            ca,
            {
              date: a,
            ...
            function (t, o, c, d) {
              return Ar(
                ...
                Ar(
                  ...
                  Ar('div', { className: 'fc-daygrid-day-bg' }, i.bgContent)
                )
              )
            }
          )
  ...
  $a.addPropsEquality({ onMoreClick: !0 })
  var es = bt({
    hour: 'numeric',
    minute: '2-digit',
    omitZeroMinute: !0,
  ...
  var ns = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this.props,
          t = this.context,
          n = t.options.eventTimeFormat || es,
          ...
          function (t, n, o, i) {
            return Ar(
              ...
              r(
                ...
                ((a = e.seg), (s = a.eventRange.def.url) ? { href: s } : {})
              ),
              i
            )
            var a, s
  ...
  function is (e, t, n, o, i, a, s, l) {
    ...
    !0 === n || !0 === o
      ? (function (e, t, n, r) {
          ss(e, t, n, !0, function (e) {
            return e.bottom <= r
          })
        })(c, d, u, a)
      : 'number' == typeof n
      ? (function (e, t, n, r) {
          ss(e, t, n, !1, function (e, t) {
            return t < r
          })
        })(c, d, u, n)
      : 'number' == typeof o &&
        (function (e, t, n, r) {
          ss(e, t, n, !0, function (e, t) {
            return t < r
          })
        })(c, d, u, o)
    for (var E = 0; E < s; E += 1) {
  ...
  var ls = (function (e) {
    function t () {
      ...
      return (
        (t.cellElRefs = new zi()),
        (t.frameElRefs = new zi()),
        (t.fgElRefs = new zi()),
        (t.segHarnessRefs = new zi()),
        (t.rootElRef = Lr()),
        (t.state = {
          framePositions: null,
    ...
    return (
      ...
      (t.prototype.render = function () {
        var e = this,
          ...
          o = this.context,
          i = t.cells.length,
          a = Ya(t.businessHourSegs, i),
          s = Ya(t.bgEventSegs, i),
          l = Ya(this.getHighlightSegs(), i),
          u = Ya(this.getMirrorSegs(), i),
          c = is(
            t.cells,
            t.fgEventSegs,
            t.dayMaxEvents,
        ...
        return Ar(
          ...
          t.cells.map(function (n, o) {
            ...
            return Ar($a, {
              ...
              fgContent: Ar(Wr, null, Ar(Wr, null, i), Ar(Wr, null, c)),
              bgContent: Ar(
                Wr,
                null,
                e.renderFillSegs(l[o], 'highlight'),
                e.renderFillSegs(a[o], 'non-business'),
                e.renderFillSegs(s[o], 'bg-event')
              )
            })
          })
        )
        ...
        if (p)
          for (var v = 0, g = e; v < g.length; v++) {
            var m = g[v],
              ...
              D = t[y] || S,
              b =
                t[y] || E || m.firstCol !== m.lastCol || !m.isStart || !m.isEnd,
              C = void 0,
              w = void 0,
              R = void 0,
              T = void 0
            b
              ? ((w = n[y]),
                c.isRtl
                  ? ((T = 0), (R = p.lefts[m.lastCol] - p.lefts[m.firstCol]))
                  : ((R = 0), (T = p.rights[m.firstCol] - p.rights[m.lastCol])))
              : (C = o[y]),
              h.push(
                Ar(
                  'div',
                  {
                    ...
                    ref: E
                      ? null
                      : this.segHarnessRefs.createRef(y + ':' + m.firstCol),
                    style: {
                      visibility: D ? 'hidden' : '',
                      marginTop: C || '',
                      top: w || '',
          ...
          for (var l = 0, u = e; l < u.length; l++) {
            var c = u[l],
              d = n
                ...
                : { left: 0, right: a.rights[c.firstCol] - a.rights[c.lastCol] }
            s.push(
              Ar(
                'div',
                {
                ...
                'bg-event' === t ? Ar(pa, r({ seg: c }, bn(c, i))) : da(t)
              )
            )
          }
        return Ar.apply(void 0, o([Wr, {}], s))
      }),
        ...
        if (null !== t.clientWidth) {
          if (e) {
            ...
            if (r.length) {
              ...
              this.setState({ framePositions: new _r(o, r, !0, !1) })
            }
          }
  ...
  ls.addPropsEquality({ onMoreClick: !0 }),
    ls.addStateEquality({ segHeights: Ve })
  var us = (function (e) {
      function t () {
        var t = (null !== e && e.apply(this, arguments)) || this
        return (
          (t.repositioner = new Zo(t.updateSize.bind(t))),
          (t.handleRootEl = function (e) {
            ;(t.rootEl = e), t.props.elRef && Kr(t.props.elRef, e)
          }),
        ...
        (t.prototype.render = function () {
          ...
          return Ar(
            ...
            Ar(
              ...
              Ar('span', { className: 'fc-popover-title' }, t.title),
              Ar('span', {
        ...
        (t.prototype.updateSize = function () {
          ...
          if (r) {
            ...
            ;(s = Math.min(s, window.innerHeight - i.height - 10)),
              ...
              q(r, { top: s, left: (o = Math.max(o, 10)) })
          }
        }),
        t
      )
    ...
    cs = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Ar(
            ca,
            { date: i, dateProfile: l, todayRange: s, elRef: this.rootElRef },
            function (e, t, n) {
              return Ar(
                us,
                {
        ...
        (t.prototype.positionToHit = function (e, t, n) {
          ...
          return l >= 0 && l < i.width && u >= 0 && u < i.height
            ? {
                dateSpan: { allDay: !0, range: { start: c, end: me(c, 1) } },
                dayEl: r,
                relativeRect: {
                  left: a,
                  top: s,
    ...
    ds = (function (e) {
      function t () {
        var t = (null !== e && e.apply(this, arguments)) || this
        return (
          (t.splitBusinessHourSegs = st(qa)),
          (t.splitBgEventSegs = st(qa)),
          (t.splitFgEventSegs = st(qa)),
          (t.splitDateSelectionSegs = st(qa)),
          (t.splitEventDrag = st(Za)),
          (t.splitEventResize = st(Za)),
          (t.buildBuildMoreLinkText = st(ps)),
          (t.morePopoverRef = Lr()),
          (t.rowRefs = new zi()),
          ...
          (t.handleMoreLinkClick = function (e) {
            ...
            'function' == typeof i &&
              ...
              i && 'popover' !== i
                ? 'string' == typeof i && n.calendarApi.zoomTo(e.date, i)
                : t.setState({
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            v = this.buildBuildMoreLinkText(this.context.options.moreLinkText),
            g = !0 === i || !0 === o
          return (
            g && !a && ((g = !1), (o = null), (i = null)),
            Ar(
              'div',
              {
                className: [
                  'fc-daygrid-body',
                  g ? 'fc-daygrid-body-balanced' : 'fc-daygrid-body-unbalanced',
                  a ? '' : 'fc-daygrid-body-natural'
                ].join(' '),
                ref: this.handleRootEl,
                style: { width: t.clientWidth, minWidth: t.tableMinWidth }
              },
              Ar(Pi, { unit: 'day' }, function (g, m) {
                return Ar(
                  Wr,
                  null,
                  Ar(
                  ...
                  !t.forPrint &&
                    s &&
                    s.currentFgEventSegs === t.fgEventSegs &&
                    Ar(cs, {
                      ...
                      alignmentEl: s.dayEl,
                      topAlignmentEl:
                        1 === l ? t.headerAlignElRef.current : null,
  ...
  function ms (e, t) {
    var n = new Ai(e.renderRange, t)
    return new Ui(n, /year|month|week/.test(e.currentRangeUnit))
  }
  var ys = lo({
  ...
  function Ds (e) {
    ...
    return Ar(jr.Consumer, null, function (n) {
      if (!e.isLabeled)
        return Ar('td', { className: t.join(' '), 'data-time': e.isoTimeStr })
      var r = n.dateEnv,
        o = n.options,
        i = n.viewApi,
        a =
          null == o.slotLabelFormat
            ...
            ? bt(o.slotLabelFormat[0])
            : bt(o.slotLabelFormat),
        s = {
          level: 0,
          time: e.time,
      ...
      return (
        ...
        (t.prototype.render = function () {
          return this.props.slatMetas.map(function (e) {
            return Ar('tr', { key: e.key }, Ar(Ds, r({}, e)))
          })
        }),
        t
      )
    ...
    Rs = (function (e) {
        ...
        return (
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            var o = t.context.options,
              ...
              s =
                o.navLinks && 1 === a
                  ? { 'data-navlink': yr(i.start, 'week'), tabIndex: 0 }
                  : {}
            return o.weekNumbers && 'day' === e
              ? Ar(
                  ha,
                  { date: i.start, defaultFormat: ws },
                  function (e, t, o, i) {
                    return Ar(
                      'th',
                      {
      ...
      return (
        ...
        (t.prototype.renderHScrollLayout = function (e, t, n, r, o, i, a) {
          ...
          var u = this.context,
            c = this.props,
            d = !c.forPrint && ea(u.options),
            p = !c.forPrint && ta(u.options),
            f = []
          e &&
            f.push({
              type: 'header',
                  ...
                  content: function (e) {
                    return Ar(
                      ...
                      Ar(
                        ...
                        e.tableColGroupNode,
                        Ar('tbody', null, Ar(Cs, { slatMetas: i }))
                      ),
                      Ar(
                        'div',
                        { className: 'fc-timegrid-now-indicator-container' },
                        Ar(Pi, { unit: h ? 'minute' : 'day' }, function (e) {
  ...
  var ks = (function () {
      ...
      return (
        (e.prototype.safeComputeTop = function (e) {
          ...
          if (un(t.currentRange, e)) {
            ...
            if (r >= et(t.slotMinTime) && r < et(t.slotMaxTime))
              return this.computeTimeTop(Xe(r))
          }
          return null
        }),
        (e.prototype.computeDateTop = function (e, t) {
          return (
            t || (t = we(e)), this.computeTimeTop(Xe(e.valueOf() - t.valueOf()))
          )
        }),
    ...
    xs = (function (e) {
      function t () {
        var t = (null !== e && e.apply(this, arguments)) || this
        return (t.rootElRef = Lr()), (t.slatElRefs = new zi()), t
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
        ...
        var o,
          i = (function (e) {
            ...
            for (t = 0; t < e.length; t += 1) {
              for (n = e[t], r = 0; r < o.length && Hs(n, o[r]).length; r += 1);
  ...
  function Os (e) {
    ...
    if (null == e.forwardPressure) {
      for (t = 0; t < r.length; t += 1)
        Os((n = r[t])), (o = Math.max(o, 1 + n.forwardPressure))
      e.forwardPressure = o
    }
  }
  function As (e, t, n, r) {
  ...
  var Ls = bt({ hour: 'numeric', minute: '2-digit', meridiem: !1 }),
    Ws = (function (e) {
      function t () {
        return (null !== e && e.apply(this, arguments)) || this
      }
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            this.props.isCondensed && e.push('fc-timegrid-event-condensed'),
            Ar(
              oa,
              r({}, this.props, { defaultTimeFormat: Ls, extraClassNames: e })
            )
          )
        }),
        t
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Ar(
            ...
            function (e, t) {
              return (
                t && Ar('div', { className: 'fc-timegrid-col-misc', ref: e }, t)
              )
            }
          )
        }),
  ...
  vi.timeGridEventCondensedHeight = 30
  var Fs = (function (e) {
      function t () {
        return (null !== e && e.apply(this, arguments)) || this
      }
      return (
        ...
        (t.prototype.renderPositionedFgSegs = function (e, t, n, o, i) {
          ...
          return (e = Ps(
            ...
            var s = e.eventRange.instance.instanceId,
              u =
                n || o || i
                  ? r({ left: 0, right: 0 }, a.computeSegTopBottomCss(e))
            ...
            return Ar(
              'div',
              {
                className:
                  ...
                  (e.level > 0 ? ' fc-timegrid-event-harness-inset' : ''),
                key: s,
                ...
                r(
                  {
                    ...
                    isCondensed:
                      e.bottom - e.top < vi.timeGridEventCondensedHeight
                  },
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          ...
          Ns(e, i.date, i.slatCoords, o.options.eventMinHeight)
          var a = e.map(function (e) {
            return Ar(
              ...
              'bg-event' === t
                ? Ar(pa, r({ seg: e }, bn(e, i.todayRange, i.nowDate)))
                : da(t)
            )
          })
          return Ar(Wr, null, a)
    ...
    zs = (function (e) {
      function t () {
        var t = (null !== e && e.apply(this, arguments)) || this
        return (
          (t.splitFgEventSegs = st(_s)),
          (t.splitBgEventSegs = st(_s)),
          (t.splitBusinessHourSegs = st(_s)),
          (t.splitNowIndicatorSegs = st(_s)),
          (t.splitDateSelectionSegs = st(_s)),
          (t.splitEventDrag = st(Is)),
          (t.splitEventResize = st(Is)),
          (t.rootElRef = Lr()),
          (t.cellElRefs = new zi()),
          t
        )
    ...
    qs = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return Ar(Pi, { unit: a ? 'minute' : 'day' }, function (l, u) {
            return Ar(
              Bs,
              r(
    ...
    for (
      var i = new Date(0),
        ...
        l =
          ...
          (function (e) {
            var t, n, r
            for (t = Zs.length - 1; t >= 0; t -= 1)
              if (((n = Xe(Zs[t])), null !== (r = tt(n, e)) && r > 1)) return n
            return e
          })(r),
        u = [];
      et(a) < et(t);
  ...
  var Ks = (function (e) {
    function t () {
      var t = (null !== e && e.apply(this, arguments)) || this
      return (t.buildTimeColsModel = st(Js)), (t.buildSlatMetas = st(Xs)), t
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
              ...
              return Ar(
                ...
                Ar(
                  ...
                  Ar(
                    ...
                    {
                      className:
                        'fc-list-day-cushion ' + i.getClass('tableCellShaded'),
                      ref: r
                    },
                    o
                  )
  ...
  function el (e) {
    ...
    return Ar(
      Wr,
      null,
      e.text && Ar('a', r({ className: 'fc-list-day-text' }, t), e.text),
      e.sideText &&
        Ar('a', r({ className: 'fc-list-day-side-text' }, t), e.sideText)
    )
  }
  var tl = bt({ hour: 'numeric', minute: '2-digit', meridiem: 'short' }),
    nl = (function (e) {
      function t () {
        return (null !== e && e.apply(this, arguments)) || this
      }
          ...
          return Ar(
            ...
            function (e, o, i, a, s) {
              return Ar(
                  ...
                  if (!1 !== r.displayEventTime) {
                    ...
                    if (
                      (o.allDay
                        ...
                        ? e.isStart
                          ? (s = Dn(e, t, n, null, null, i.range.start, e.end))
                          : e.isEnd
                          ? (s = Dn(e, t, n, null, null, e.start, i.range.end))
                          : (a = !0)
                        : (s = Dn(e, t, n)),
                      a)
                    ) {
                    ...
                    return Ar('td', { className: 'fc-list-event-time' }, s)
                  }
                  return null
                })(n, r, t),
                Ar(
                ...
                Ar('td', { className: 'fc-list-event-title', ref: i }, a)
              )
            }
          )
        }),
  ...
  function rl (e) {
    var t = e.event,
      n = t.url
    return Ar('a', r({}, n ? { href: n } : {}), t.title)
  }
  function ol (e) {
    return e.text
  }
  var il = (function (e) {
    function t () {
      var t = (null !== e && e.apply(this, arguments)) || this
      return (
        (t.computeDateVars = st(sl)),
        (t.eventStoreToSegs = st(t._eventStoreToSegs)),
    ...
    return (
        ...
        return Ar(
          ...
          function (e, t, n, r) {
            return Ar(
              ...
              Ar('div', { className: 'fc-list-empty-cushion', ref: n }, r)
            )
          }
        )
      }),
      (t.prototype.renderSegList = function (e, t) {
        ...
        return Ar(Pi, { unit: 'day' }, function (e, n) {
          for (var s = [], l = 0; l < a.length; l += 1) {
            var u = a[l]
            if (u) {
              var c = t[l].toISOString()
              s.push(Ar(Qs, { key: c, dayDate: t[l], todayRange: n }))
              for (
                var d = 0, p = (u = gn(u, i.eventOrder));
                d < p.length;
                d++
              ) {
                var f = p[d]
  ...
  function sl (e) {
    for (
      var t = we(e.renderRange.start), n = e.renderRange.end, r = [], o = [];
      t < n;

    )
      r.push(t), o.push({ start: t, end: me(t, 1) }), (t = me(t, 1))
  ...
  ;(cl.prototype.classes = {
    ...
    (cl.prototype.baseIconClass = 'fa'),
    (cl.prototype.iconClasses = {
      close: 'fa-times',
    ...
    (cl.prototype.rtlIconClasses = {
      prev: 'fa-chevron-right',
      next: 'fa-chevron-left',
      prevYear: 'fa-angle-double-right',
      nextYear: 'fa-angle-double-left'
    }),
    (cl.prototype.iconOverrideOption = 'bootstrapFontAwesome'),
    (cl.prototype.iconOverrideCustomButtonOption = 'bootstrapFontAwesome'),
    (cl.prototype.iconOverridePrefix = 'fa-')
  var dl = lo({ themeClasses: { bootstrap: cl } })
  var pl = lo({
    eventSourceDefs: [
      {
        parseMeta: function (e) {
            ...
            var u = (function (e) {
              ...
              p = (function (e, t, n, o) {
                ...
                o.canComputeOffset
                  ...
                  : ((a = me(e.start, -1).toISOString()),
                    (s = me(e.end, 1).toISOString()))
                ;(i = r(r({}, n || {}), {
                  key: t,
                  timeMin: a,
                  timeMax: s,
  ...
  return (
    Go.push(ja, ys, $s, ul, dl, pl),
    (e.BASE_OPTION_DEFAULTS = wt),
    (e.BASE_OPTION_REFINERS = Ct),
    (e.BaseComponent = Yr),
    (e.BgEvent = pa),
    (e.BootstrapTheme = cl),
    (e.Calendar = ga),
    (e.CalendarApi = zn),
    (e.CalendarContent = Ci),
    (e.CalendarDataManager = Jo),
    (e.CalendarDataProvider = li),
    (e.CalendarRoot = Ti),
    (e.Component = Or),
    (e.ContentHook = vo),
    (e.CustomContentRenderContext = ho),
    (e.DateComponent = so),
    (e.DateEnv = Jn),
    (e.DateProfileGenerator = To),
    (e.DayCellContent = la),
    (e.DayCellRoot = ca),
    (e.DayGridView = gs),
    (e.DayHeader = Hi),
    ...
    (e.DayTableSlicer = hs),
    (e.DayTimeCols = qs),
    (e.DayTimeColsSlicer = Gs),
    (e.DayTimeColsView = Ks),
    (e.DelayedRunner = Zo),
    (e.Draggable = Fa),
    (e.ElementDragging = hi),
    (e.ElementScrollController = Pr),
    (e.Emitter = xr),
    (e.EventApi = Bn),
    (e.EventRoot = ra),
    (e.EventSourceApi = V),
    (e.FeaturefulElementDragging = Ma),
    (e.Fragment = Wr),
    (e.Interaction = ci),
    (e.ListView = il),
    (e.MountHook = mo),
    (e.NamedTimeZoneImpl = ui),
    (e.NowIndicatorRoot = aa),
    (e.NowTimer = Pi),
    (e.PointerDragging = Sa),
    (e.PositionCache = _r),
    (e.RefMap = zi),
    (e.RenderHook = fo),
    (e.ScrollController = Ir),
    (e.ScrollResponder = Br),
    (e.Scroller = Fi),
    (e.SimpleScrollGrid = na),
    (e.Slicer = Li),
    (e.Splitter = hr),
    (e.StandardEvent = oa),
    (e.Table = ds),
    ...
    (e.TableView = Ga),
    (e.Theme = Hr),
    (e.ThirdPartyDraggable = Ba),
    (e.TimeCols = Bs),
    (e.TimeColsSlatsCoords = ks),
    (e.TimeColsView = Rs),
    (e.ViewApi = Un),
    (e.ViewContextType = jr),
    (e.ViewRoot = Do),
    (e.WeekNumberRoot = ha),
    ...
    (e.addMs = ye),
    (e.addWeeks = ge),
    (e.allowContextMenu = ae),
    (e.allowSelection = oe),
    (e.applyMutationToEventStore = Hn),
    (e.applyStyle = q),
    (e.applyStyleProp = Y),
    ...
    (e.buildClassNameNormalizer = yo),
    (e.buildDayRanges = Ys),
    (e.buildDayTableModel = ms),
    (e.buildEventApis = Gn),
    (e.buildEventRangeKey = wn),
    ...
    (e.buildNavLinkData = yr),
    (e.buildSegCompareObj = mn),
    (e.buildSegTimeText = Dn),
    (e.buildSlatMetas = Xs),
    (e.buildTimeColsModel = Js),
    (e.collectFromHash = je),
    (e.combineEventUis = Bt),
    (e.compareByFieldSpec = ue),
    (e.compareByFieldSpecs = le),
    (e.compareNumbers = pe),
    (e.compareObjs = ze),
    (e.computeEdges = wr),
    (e.computeFallbackHeaderFormat = ki),
    ...
    (e.computeInnerRect = Rr),
    (e.computeRect = Tr),
    (e.computeSegDraggable = yn),
    (e.computeSegEndResizable = Sn),
    (e.computeSegStartResizable = En),
    (e.computeShrinkWidth = Bi),
    (e.computeSmallestCellWidth = he),
    ...
    (e.createDuration = Xe),
    (e.createElement = Ar),
    (e.createEmptyEventStore = At),
    (e.createEventInstance = Ne),
    (e.createEventUi = zt),
    (e.createFormatter = bt),
    (e.createPlugin = lo),
    (e.createRef = Lr),
    (e.diffDates = tn),
    (e.diffDayAndTime = De),
    ...
    (e.formatDayString = rt),
    (e.formatIsoTimeString = ot),
    (e.formatRange = function (e, t, n) {
      var r = rr('object' == typeof n && n ? n : {}),
        o = bt(n),
    ...
    (e.getAllowYScrolling = Gi),
    (e.getCanVGrowWithinCell = pr),
    (e.getClippingParents = kr),
    (e.getDateMeta = gr),
    (e.getDayClassNames = mr),
    (e.getDefaultEventEnd = Nn),
    (e.getElSeg = fn),
    (e.getEventClassNames = Cn),
    (e.getIsRtlScrollbarOnLeft = Dr),
    (e.getRectCenter = cr),
    (e.getRelevantEvents = Ot),
    (e.getScrollGridClassNames = Ji),
    (e.getScrollbarWidths = br),
    (e.getSectionClassNames = $i),
    (e.getSectionHasLiquidHeight = ji),
    (e.getSegMeta = bn),
    ...
    (e.getStickyFooterScrollbar = ta),
    (e.getStickyHeaderDates = ea),
    (e.getUnequalProps = Fe),
    (e.globalLocales = $n),
    (e.globalPlugins = Go),
    (e.greatestDurationDenominator = nt),
    (e.guid = ee),
    (e.hasBgRendering = dn),
    (e.hasShrinkWidth = Ki),
    (e.identity = Pt),
    (e.interactionSettingsStore = fi),
    (e.interactionSettingsToStore = pi),
    (e.intersectRanges = on),
    (e.intersectRects = lr),
    (e.isArraysEqual = at),
    (e.isColPropsEqual = Yi),
    (e.isDateSpansEqual = kn),
    (e.isInt = fe),
    (e.isInteractionValid = eo),
    ...
    (e.memoizeObjArg = lt),
    (e.mergeEventStores = Ut),
    (e.multiplyDuration = $e),
    (e.padStart = de),
    (e.parseBusinessHours = ar),
    (e.parseClassNames = Wt),
    (e.parseDragMeta = mi),
    (e.parseEventDef = Jt),
    (e.parseFieldSpecs = se),
    (e.parseMarker = Kn),
    (e.pointInsideRect = sr),
    (e.preventContextMenu = ie),
    (e.preventDefault = Z),
    (e.preventSelection = re),
    (e.rangeContainsMarker = un),
    (e.rangeContainsRange = ln),
    (e.rangesEqual = an),
    (e.rangesIntersect = sn),
    (e.refineEventDef = Xt),
    (e.refineProps = It),
    (e.removeElement = F),
    ...
    (e.render = Ur),
    (e.renderChunkContent = qi),
    (e.renderFill = da),
    (e.renderMicroColGroup = Zi),
    (e.renderScrollShim = Qi),
    (e.requestJson = zo),
    (e.sanitizeShrinkWidth = Xi),
    (e.setElSeg = pn),
    (e.setRef = Kr),
    (e.sliceEventStore = cn),
    ...
    (e.triggerDateSelect = In),
    (e.unmountComponentAtNode = zr),
    (e.unpromisify = Mr),
    (e.version = '5.5.1'),
    (e.whenTransitionDone = $),
    (e.wholeDivideDurations = tt),
